...
In the new pop-up window, select "Freenove_Super_Starter_Kit_for_ESP32_S3\\C\\Libraries\\ESP32-audioI2S.zip". 
...
**Freenove_Super_Starter_Kit_for_ESP32_S3\\Sketches\\Sketch_29.2_SDMMC_Music.**
