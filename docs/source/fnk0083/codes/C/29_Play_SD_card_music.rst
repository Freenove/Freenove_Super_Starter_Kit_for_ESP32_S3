...
In the new pop-up window, select " **Freenove_Super_Starter_Kit_for_ESP32_S3\\C\\Libraries\\ESP8266Audio.zip** ". Then click "Open".
...
.. literalinclude:: ../../../freenove_Kit/C/Sketches/Sketch_22.1_PlayMP3FromSD/Sketch_22.1_PlayMP3FromSD.ino
    :linenos: 
    :language: c
    :dedent:
